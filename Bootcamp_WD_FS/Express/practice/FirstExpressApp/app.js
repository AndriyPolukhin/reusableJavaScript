...
app.get("/r/:subredditName", function(req, res) {
    ...
    res.send("Welcome to the page about " + subreddit.toUpperCase() + " Subreddit");
});
...
app.get("/r/:subredditName/comments/:id/:title/", function (req, res) {
    ...
    res.send("Welcome to the page about " + subreddit + "Under the id " + id + " Titled: " + title);
});

// 5. All of the rest that are not actual routes

app.get("*", function (req, res) {
    res.send("THIS IS NOT an Actual Route. Please check the page address!");
});
