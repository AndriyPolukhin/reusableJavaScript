/**
 * Querying Trees
 * Ex.9: Flatten the array into an array
...
/**
 * @TODO: Flatten the movieLists array into an array of video ids
...
movieLists.forEach(category => {
  category.videos.forEach(i => allVideoIdsInMovieLists.push(i.id));
});
